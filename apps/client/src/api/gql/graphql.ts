...
export type GenericMorph = Clubroom | CommentsComment | CommentsCommentReport | ComponentHomepageHomeImage | ComponentHomepageTroop | ComponentMenuItem | ComponentMenuItem2 | ComponentPersonCardKontakt | ComponentPersonCardTroop | ComponentTotemLegend | ComponentTotemTotemComment | Contact | EmailDesignerEmailTemplate | Homepage | I18NLocale | Leader | LeaderMenu | MemberRegistration | PhotoGallery | Post | TopBar | Totem | Troop | TroopContact | UploadFile | UploadFolder | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser;
...
export type MemberRegistrationFilesArgs = {
  filters?: InputMaybe<UploadFileFiltersInput>;
  pagination?: InputMaybe<PaginationArg>;
  sort?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
};

export type MemberRegistrationEntity = {
  __typename?: 'MemberRegistrationEntity';
  attributes?: Maybe<MemberRegistration>;
  id?: Maybe<Scalars['Id']>;
};

export type MemberRegistrationEntityResponse = {
  __typename?: 'MemberRegistrationEntityResponse';
  data?: Maybe<MemberRegistrationEntity>;
};
...
export type Mutation = {
  ...
  deleteMemberRegistration?: Maybe<MemberRegistrationEntityResponse>;
  ...
  updateMemberRegistration?: Maybe<MemberRegistrationEntityResponse>;
...
export type MutationUpdateMemberRegistrationArgs = {
...
export type Query = {
  ...
  memberRegistration?: Maybe<MemberRegistrationEntityResponse>;
...
export type GetMemberRegistrationDataQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMemberRegistrationDataQuery = { __typename?: 'Query', memberRegistration?: { __typename?: 'MemberRegistrationEntityResponse', data?: { __typename?: 'MemberRegistrationEntity', attributes?: { __typename?: 'MemberRegistration', title?: string | null, content?: string | null, visible?: boolean | null, files?: { __typename?: 'UploadFileRelationResponseCollection', data: Array<{ __typename?: 'UploadFileEntity', id?: any | null, attributes?: { __typename?: 'UploadFile', name: string, previewUrl?: string | null, url: string, formats?: any | null, caption?: string | null } | null }> } | null } | null } | null } | null };
...
export const GetMemberRegistrationDataDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetMemberRegistrationData"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"memberRegistration"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"data"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"attributes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"visible"}},{"kind":"Field","name":{"kind":"Name","value":"files"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"data"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"attributes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"previewUrl"}},{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"formats"}},{"kind":"Field","name":{"kind":"Name","value":"caption"}}]}},{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetMemberRegistrationDataQuery, GetMemberRegistrationDataQueryVariables>;
