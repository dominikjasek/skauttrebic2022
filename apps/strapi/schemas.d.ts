...
export interface ApiHomepageHomepage extends SingleTypeSchema {
  ...
  attributes: {
    images: ComponentAttribute<'homepage.home-image', true>;
    troops: ComponentAttribute<'homepage.troop', true>;
    createdAt: DateTimeAttribute;
    updatedAt: DateTimeAttribute;
    createdBy: RelationAttribute<
...
export interface ApiPostPost extends CollectionTypeSchema {
  ...
  attributes: {
    ...
    troops: RelationAttribute<
      'api::post.post',
      'manyToMany',
      'api::troop.troop'
    >;
    user_likes: RelationAttribute<
      'api::post.post',
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    schedule_publish_at: DateTimeAttribute;
    createdAt: DateTimeAttribute;
    updatedAt: DateTimeAttribute;
...
export interface ApiTopBarTopBar extends SingleTypeSchema {
  info: {
    singularName: 'top-bar';
    pluralName: 'top-bars';
    displayName: 'Horn\u00ED li\u0161ta';
    description: '';
  };
  options: {
    draftAndPublish: false;
  ...
  attributes: {
    ...
    type: EnumerationAttribute<['info', 'upozorn\u011Bn\u00ED']>;
    createdAt: DateTimeAttribute;
    updatedAt: DateTimeAttribute;
    createdBy: RelationAttribute<
      'api::top-bar.top-bar',
...
export interface ApiTroopTroop extends CollectionTypeSchema {
  info: {
    singularName: 'troop';
    pluralName: 'troops';
    displayName: 'Odd\u00EDly';
  ...
  attributes: {
    ...
    subscribed_users: RelationAttribute<
      'api::troop.troop',
      'manyToMany',
      'plugin::users-permissions.user'
    >;
...
export interface PluginUsersPermissionsUser extends CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      DefaultTo<'child'>;
    subscribing_troops: RelationAttribute<
      'plugin::users-permissions.user',
      'manyToMany',
      'api::troop.troop'
    >;
    post_likes: RelationAttribute<
      'plugin::users-permissions.user',
      'manyToMany',
      'api::post.post'
    >;
...
export interface HomepageHomeImage extends ComponentSchema {
  info: {
    displayName: 'Image';
    icon: 'images';
    description: '';
  ...
  attributes: {
    ...
    background_color: StringAttribute &
      CustomField<'plugin::color-picker.color'>;
  };
}

export interface HomepageTroop extends ComponentSchema {
  info: {
    displayName: 'troop';
    icon: 'hotel';
  };
  attributes: {
    ...
    age_gender_information: StringAttribute;
...
declare global {
  namespace Strapi {
    interface Schemas {
      ...
      'homepage.home-image': HomepageHomeImage;
      'homepage.troop': HomepageTroop;
    }
  }
}
